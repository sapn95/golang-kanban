...
Every route the server answers, all 44 of them, registered in one block in
...
The last of those 44 is the JSON API, which brings its own thirty-one routes under
